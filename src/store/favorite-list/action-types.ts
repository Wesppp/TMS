export enum ActionTypes {
  ADD_TO_FAVORITE = '[App] add to favorite ',
  ADD_TO_FAVORITE_SUCCESS = '[App] add to favorite success',
  ADD_TO_FAVORITE_FAILURE = '[App] add to favorite failure',

  REMOVE_FROM_FAVORITE = '[Favorite list] remove from favorite',
